...
Account should have appropriate rights to run "Get-Mailbox", "Search-Mailbox" and "Get-MailboxStatistics" cmdlets.
...
Author - Vyacheslav Fedenko - http://blog.fedenko.info
